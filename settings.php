...
<div id="wrapper">
 	...
 	<div class="blank">
			...
			<div class="blank-page">
                <h3>Change Graph Color</h3></br>
        <?php
            $rs = $db->query("select color from settings");
            $co = $rs->fetch_array();
        ?>
                <form action="php_scripts/change_color.php" method="post">
                  Select your favorite color:
                  <input type="color" name="favcolor" value="<?php echo $co['color']; ?>">
                  <input type="submit" value="Change Color">
                </form>
            <?php
                if(isset($_GET['id'])) echo "<span>Color Changed. Wait few minutes to apply changes.</span>";
            ?>
</div>
</div>
