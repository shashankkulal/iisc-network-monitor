        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $ipdetails['sname']; ?> History</li>
                </ul>
                <!-- END BREADCRUMB -->                                                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">                                
                                <div class="panel-body">
                                    <h3>History for <?php echo $ipdetails['fname']; ?></h3>
                                        <div class="col-md-8">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="timeline timeline-right" style="height: auto;">
                                ...
                                <div class="timeline-item timeline-item-right">
                                    <div class="timeline-item-info" id="1hour">Last 4 Hour</div>
                                    <div class="timeline-item-icon"><span class="fa fa-globe"></span></div>
                                    <div class="timeline-item-content">
                                        <div class="timeline-body">
                                               <img style="max-width: 100%;" src="http://10.114.5.65/python_engine/tree/images/ps<?php echo $ip; ?>4h.png">                                      
                                        </div>                                       
                                    </div>
                                </div>       
                                <!-- END TIMELINE ITEM -->
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-item-content">
                                        <div class="timeline-body">
                                             <img style="max-width: 100%;" src="http://10.114.5.65/python_engine/tree/images/ping_statistics_<?php echo $ip; ?>.png">                                     
                                        </div>                                       
                                    </div>
                                </div>       
                                <!-- END TIMELINE ITEM -->
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-item-content">
                                        <div class="timeline-body">
                                             <img style="max-width: 100%;" src="http://10.114.5.65/python_engine/tree/images/ps<?php echo $ip; ?>1w.png">                                     
                                        </div>                                       
                                    </div>
                                </div>       
                                <!-- END TIMELINE ITEM -->
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-item-content">
                                        <div class="timeline-body">
                                             <img style="max-width: 100%;" src="http://10.114.5.65/python_engine/tree/images/ps<?php echo $ip; ?>4w.png">                                     
                                        </div>                                       
                                    </div>
                                </div>       
                                <!-- END TIMELINE ITEM -->
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-item-content">
                                        <div class="timeline-body">
                                            <img style="max-width: 100%;" src="http://10.114.5.65/python_engine/tree/images/ps<?php echo $ip; ?>24w.png">                                      
                                        </div>                                       
                                    </div>
                                </div>       
                                <!-- END TIMELINE ITEM -->
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-item-content">
                                        <div class="timeline-body">
                                            <img style="max-width: 100%;" src="http://10.114.5.65/python_engine/tree/images/ps<?php echo $ip; ?>1y.png">                                      
                                        </div>                                       
                                    </div>
                                </div>       
                                <!-- END TIMELINE ITEM -->
